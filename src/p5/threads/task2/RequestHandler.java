...
public class RequestHandler implements Runnable {
	 ...
	 * 
	 * in JAVA every object has a key called - monitor(unique) 1 person - 1 monitor
	 * 3 persons - 3 monitors every object has 1 monitor
	 * 
	 * when we enter to the critical section of an object: we should present the
	 * key(monitor)
	 * 
	 * *** the monitor has another name - lock flag *** *** we can also synchronize
	 * a block of code and not just a method ***
	 */
	@Override
